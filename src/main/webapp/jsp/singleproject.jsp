	...
	<div id="body">
		...
		<c:if test="${li.projecttype==6 }">军火类</c:if>
			...
			<form action="/p2p/zkj/money.do?subjectid=${li.id }" method="post"   onsubmit="return check(this)">
				...
				<i id="did"></i><br/>
				<input id="sub" type="submit" class="btn btn-danger" value="立即投标">  
			...
			<div>
				  ...
				  <ul class="nav nav-tabs" role="tablist">
				    <li role="presentation" class="active"><a href="#home" aria-controls="home" role="tab" data-toggle="tab"><b>借款人详情</b></a></li>
				    <li role="presentation"><a href="#profile" aria-controls="profile" role="tab" data-toggle="tab"><b>投标记录</b></a></li>
				  ...
				  <div class="tab-content">
				    <div role="tabpanel" class="tab-pane active" id="home">
				     ...
				     <div id="ttablediv">
					    <table >
					    	<tr>
					    		<td id="cui" colspan="3">借款人详情</td><td></td><td></td>
					    	</tr>
					    	<tr>
					    		<td class="yong">用户呢称</td><td class="sex">${username }</td><td rowspan="8"><img  src="../bootstrap/images/tong.png"/></td>
					    	</tr>
					    	<tr>
					    		<td class="yong">性别</td><td class="sex">${li.SEX }</td><td></td>
					    	</tr>
					    	<tr>
					    		<td class="yong">学历</td><td class="sex">${li.EDUCATIONAL }</td><td></td>
					    	</tr>
					    	<tr>
					    		<td class="yong">工作年限</td><td class="sex">${li.WORKLIFE }年</td><td></td>
					    	</tr>
					    	<tr>
					    		<td class="yong">是否已婚</td><td class="sex">${li.MARRIAGE }</td><td></td>
					    	</tr>
					    	<tr>
					    		<td class="yong">是否有房</td><td class="sex">${li.HAVEROOM }</td><td></td>
					    	</tr>
					    	<tr>
					    		<td class="yong">是否房贷</td><td class="sex">${li.HOUSELOAN }</td><td></td>
					    	</tr>
					    	<tr>
					    		<td class="yong">现居地</td><td class="sex">${li.ADDRESS }</td><td></td>
					    	</tr>
					    </table>
				    </div>
				    </c:forEach>
				    	<div id="tablediv">
							<c:forEach items="${investinformation }" var="li">
								<table>
							    	<tr>
							    		<td id="jie" colspan="3">借款标信息</td><td></td><td></td>
							    	</tr>
							    	<tr>
							    		<td class="yong">借款期限</td><td class="sex">${li.LIFELOAN }</td><td rowspan="7"><img  src="../bootstrap/images/tong.png"/></td>
							    	</tr>
							    	<tr>
							    		<td class="yong">借款金额</td><td class="sex">${li.MONEY }</td><td></td>
							    	</tr>
							    	<tr>
							    		<td class="yong">收益率</td><td class="sex">${li.RATEMONEY }</td><td></td>
							    	</tr>
							    	<tr>
							    		<td class="yong">借款用途项目</td><td class="sex">${li.PROJECTNAME }</td><td></td>
							    	</tr>
							    	<tr>
							    		<td class="yong">项目地点</td><td class="sex">${li.LOCATION }</td><td></td>
							    	</tr>
							    	<tr>
							    		<td class="yong">还款方式</td><td class="sex">${li.HAVEROOM }</td><td></td>
							    	</tr>
							    	<tr>
							    		<td class="yong">投标截止时间</td><td class="sex">${li.HOUSELOAN }</td><td></td>
							    	</tr>
							    	<tr>
							    		<td class="yong"></td><td class="sex">${li.ADDRESS }</td><td></td>
							    	</tr>
							    </table>
								...
								<table>
							    	<tr>
							    		<td colspan="3" id="qi">其他审核资料</td><td></td><td></td>
							    	</tr>
							    	<tr>
							    		<td class="yong">身份证信息</td><td class="sex">已验证</td><td rowspan="6"><img  src="../bootstrap/images/xiaodian.png"/></td>
							    	</tr>
							    	<tr>
							    		<td class="yong">银行卡信息</td><td class="sex">已验证</td><td></td>
							    	</tr>
							    	<tr>
							    		<td class="yong">信用报告</td><td class="sex">已验证</td><td></td>
							    	</tr>
							    	<tr>
							    		<td class="yong">收入证明</td><td class="sex">已验证</td><td></td>
							    	</tr>
							    	<tr>
							    		<td class="yong">工作证</td><td class="sex">已验证</td><td></td>
							    	</tr>
							    	<tr>
							    		<td class="yong">联系人信息</td><td class="sex">已验证</td><td></td>
							    	</tr>
				    ...
				    <div role="tabpanel" class="tab-pane" id="profile">
				    		<div>
								<table class="table table-hover">
								    	<tr>
								    		<td class="yyyy"><b>呢称</b></td><td class="yyyy"><b>投标金额</b></td><td class="yyyy"><b>投标日期</b></td>
								    	</tr>
