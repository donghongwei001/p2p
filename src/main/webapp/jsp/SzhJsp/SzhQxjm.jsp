	...
	<div id="handlerDialog">
		<form id="myForm" method="post">
			<table width="100%" class="formtable">
				<tr>
					<th height="40">用户编号：</th><td><input id="userID" name="userID" class="easyui-validatebox" data-options="required:true"></td>
				</tr>
				<tr>
					<th height="40">用户名称：</th><td><input id="username" name="username" class="easyui-validatebox" data-options="required:true"></td>
				</tr>
				<tr>
					<th height="40">用户密码：</th><td><input id="pwd" name="pwd" class="easyui-validatebox" data-options="required:true"></td>
				</tr>	
				<tr>
					<th height="40" >账户余额：</th><td><input id="money" name="money" class="easyui-validatebox" data-options="required:true"></td>
				</tr>											
			</table>
		</form>
	</div>
