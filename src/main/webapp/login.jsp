...
<div id="js-modal-holder" class="modal-holder">
  <div id="js-hint1" class="hint hint--1">填写用户名<br>密码<br>千万别错啊！</div>
  <div id="js-hint2" class="hint hint--2">填写<br>或关闭</div>
  ...
  <form action="/p2p/emp/login.do" id="js-modal" class="modal" method="post">
	...
	<div class="modal__section">
		<div class="input-with-label">
		  <input id="name" name="username" type="text" class="input-with-label__input">
	...
	<div class="modal__section">
		<div class="input-with-label">
		  <input id="password1" name="password" type="password" class="input-with-label__input">
